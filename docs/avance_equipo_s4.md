...
6. **Víctor** → probar el selector MobileNetV2 en la página M1 ahora que el modelo existe y el bug de `IMAGE_CLASSES` está corregido — ojo que el modelo detrás del selector sigue siendo el de Fase 1 hasta que César resuelva el punto 1
