...
El bloqueo de integración de Ghinno quedó resuelto — el modelo BETO ya corre en `predict()`, y la comparativa RF vs BETO ya está en ambos notebooks. El riesgo nuevo y más urgente es el de César: no mergear `module/m1-cesar` hasta confirmar que Fase 2 corrió de verdad.
