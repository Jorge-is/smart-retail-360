...
from src.utils.config import SENTIMENT_BETO_MODEL_PATH, BETO_MODEL_NAME
...
def _load():
    ...
    if _model is None:
        ...
        _model = TFAutoModelForSequenceClassification.from_pretrained(path)
...
def build_model_for_training(num_labels: int = 3):
    ...
    model = TFAutoModelForSequenceClassification.from_pretrained(BETO_MODEL_NAME, num_labels=num_labels)
